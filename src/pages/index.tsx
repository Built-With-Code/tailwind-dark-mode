...
export default function Home() {
  return (
    <div>
      <main className="flex min-h-screen flex-col p-12 bg-neutral-100 ">
        <nav className="grid grid-cols-3 items-center">
          <h1 className="text-xl font-semibold ">DesignConference</h1>
        ...
        <section className="w-[90%] max-w-3xl mx-auto mt-40 flex flex-col gap-8">
          ...
          <p className="text-sky-800 text-2xl tracking-wide leading-relaxed">
